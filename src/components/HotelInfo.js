...
const HotelInfo = () => {
  ...
  const loadServicesData = async() => {
    const resp = await fetch(
      'https://rubyzdrqpl.execute-api.eu-west-2.amazonaws.com/Production/services'
    )
  ...
  const loadAccessibilityData = async () => {
    const resp = await fetch(
      'https://rubyzdrqpl.execute-api.eu-west-2.amazonaws.com/Production/accessibilities'
    )
    let jsonData = await resp.json()
    ...
    return (
      <div className="scene" id="hotelinfo">
        ...
        <article id="usefulinfo">
          <section id="arrivalinfo">
            ...
            <ul>
              ...
              <li>
                ...
                shuttles leave every hour on the hour, and make trips to
          ...
          <section className="checklist" id="accessibility">
            ...
            <p>
              ...
              every individual. We offer the following facilities for those with
              special needs:
            </p>
            <ul>
        ...
        <article id="greenprogram">
          ...
          <p>
            <strong>The Landon Hotel - London</strong> was recently renovated,
            ...
            appliances throughout the hotel - we’re saving energy in every
            socket, outlet, and switch. We’ve also initiated a recycling and
